...
{	
	...
	props = props || {};
	this.id = Elf.UID.create("Graphics");
...
Elf.Graphics.prototype = new Elf.DisplayObject();
 ...
 * @private
 */
Graphics.prototype._draw = function(stage)
{	
...
Graphics._getContext = function(){
	var _canvas = Elf.createDOM('canvas');
